...
ENV NodeVersion __NODEJS_VERSION__
ENV node_modules /usr/local/node/lib/node_modules
...
ENTRYPOINT "${node_modules}/pm2/bin/pm2 start -x /home/www_nodejs/server.js  --watch --no-daemon --log /var/log/"
